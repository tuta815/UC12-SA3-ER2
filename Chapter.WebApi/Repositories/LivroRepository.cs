    ...
    public class LivroRepository
    {
        ...
        public List<Livro> Listar()
        {
            var livros = new List<Livro>() 
            {
                ...
                new Livro() { Id = 5, Disponivel = false, QuantidadePaginas = 110, Titulo = "Teste de um novo livro" },
                new Livro() { Id = 5, Disponivel = false, QuantidadePaginas = 1, Titulo = "Folha de papel" }
            };
            return livros;
        }
